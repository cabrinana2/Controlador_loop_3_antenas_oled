...
// Definir constantes pantalla oled
...
void etiquetador()   //FUNCION QUE COMPONE LA FRECUENCIA PARA MOSTRAR EN LA MEMORIA
    {         
 display.setCursor(12, 0);      // ubica cursor en columna 13 y linea 1  
 display.print("SAVE ");   // escribe el valor de khz  
 display.setCursor(12, 19);      // ubica cursor en columna 13 y linea 1  
 display.print("FREQ         KHZ");   // escribe el valor de khz  
 display.setCursor(48, 19);      // ubica cursor en columna 12 y linea 0
 display.print(khz);  
 Time = millis();   
 Serial.println(khz); 
 display.display();
...
if(digitalRead(memDOWN)==LOW){
 ...
 if(khz != lastkhz){  
   Serial.println(khz);     
   lastkhz=khz;
   display.setCursor(48, 19);      // ubica cursor en columna 6 y linea 1
   if(khz<10000 && khz>=1000) display.print("0");
   if(khz<1000 && khz>=100) display.print("00");
   else if(khz<100 && khz>=10) display.print("000");
   else if(khz<10) display.print("0000");
   display.print(khz);   // escribe el valor de khz
   Time = millis(); 
   display.display(); 
 }  
  
}
 display.setCursor(48, 19);      // ubica cursor en columna 13 y linea 1  
 display.print("          ");   // borra el valor de khz 
display.display();
}
...
void autozero(){
               display.setCursor(12, 19);      // ubica cursor en columna 0 y linea 1
               display.print(" LOOKING FOR 0  "); 
               display.display();
               ...
               if(digitalRead(upSwitch)==LOW) {display.setCursor(12, 19);      // ubica cursor en columna 0 y linea 1
                                               display.print("                ");  
                                               display.display();
                                               limitesup ();
                                               delay (1000);
...
void pantalla(){
  display.clearDisplay();
  display.setCursor(48, 0);      // ubica cursor en columna 6 y linea 0
  display.print("MEM");   
  display.print(memstep);        //
  display.setCursor(84, 0);      // ubica cursor en columna 12 y linea 0
  display.print("ANT");   
  display.print(antena);        // 
  funcionmenu = 0;
  display.setCursor(12, 19);      // ubica cursor en columna 12 y linea 0
  display.print("MEM             "); 
  display.setCursor(48, 19);      // ubica cursor en columna 12 y linea 0
  display.print(khz); 
  display.print(" Khz"); 
...
void limiteinf (){  
  display.setCursor(42, 19);      // ubica cursor en columna 6 y linea 1
  display.print("DOWN LIMIT");
  display.display();
  delay(2000);
  display.setCursor(42, 19);      // ubica cursor en columna 6 y linea 1
  display.print("ADJUSTING 0");
  display.display();
  ...
  if(digitalRead(memUP)==LOW || digitalRead(memDOWN)==LOW || savmem==1){  //Seleccionamos botones memoria arriba y abajo
    ...
    if(digitalRead(memDOWN)==LOW && funcionmenu == 1){
                 ...
                 switch(memstep){
                  ...
                  savmem = 0;
                  EEPROM.get(mempointer+4,b);
                  display.setCursor(42, 19);      // ubica cursor en columna 12 y linea 0
                  display.print("SAVE1      "); 
                  display.setCursor(78, 19);      // ubica cursor en columna 12 y linea 0
                  display.print(b); 
                  display.display();                                 
                  delay(3000); 
                  funcionmenu = 0;
    ...
    display.setCursor(66, 19);      // ubica cursor en columna 6 y linea 0
    display.print(b);   // escribe el valor de encodervalue 
    display.setCursor(48, 19);      // ubica cursor en columna 6 y linea 0
    display.print("        UP");   // escribe el valor de encodervalue
    display.display();
...
saltoup:   
    ...
    display.print("       ");   // escribe el valor de encodervalue      
    display.display();                   
                       }
  
  if (encoderValue > b)
                      {  //Comparamos encodervalue con el paso de destino que en este caso es inferior en numero
    display.setCursor(54, 19);      // ubica cursor en columna 6 y linea 0
    display.print(b);   // escribe el valor de encodervalue 
    display.setCursor(48, 19);      // ubica cursor en columna 6 y linea 0
    display.print("      DOWN");   // escribe el valor de encodervalue 
    display.display();    
...
saltodown:    
    ...
    if (nodata==1 && funcionmenu==0) {
      display.setCursor(48, 19);      // ubica cursor en columna 6 y linea 0
      display.print("NO DATA  ");   // escribe el valor de encodervalue
      display.display();
      delay (1000);
      display.setCursor(48, 19);      // ubica cursor en columna 6 y linea 0
      display.print("0 Khz     ");   // escribe el valor de encodervalue
      display.setCursor(54, 19);      // ubica cursor en columna 6 y linea 0 
      display.display();     
      nodata=0;
      }
   display.setCursor(48, 19);      // ubica cursor en columna 6 y linea 0
   display.print(khz);   // escribe el valor de encodervalue  
   display.print(" Khz");   // escribe el valor de encodervalue 
   display.display(); 
   EEPROM.put(mempointer+40,khz);
...
void loop(){ 
  ...
  if(antena > 4 || antena < 1 ){      //si la lectura de antena no es un numero entre 1 y 4 se entiende que es la primera vez que se utiliza el controlador  
                  ...
                  display.clearDisplay();                    
                  display.setCursor(12, 0);      // ubica cursor en columna 0 y linea 0
                  display.print(" PREPARING FOR"); 
                  display.setCursor(12, 19);      // ubica cursor en columna 0 y linea 1  
                  display.print(" THE FIRST USE"); 
                  display.display();
                  delay(2000);                                     
        for (i=0; i <= 1000; i++) {
  ...
  display.clearDisplay();
  display.setCursor(12, 0);      // ubica cursor en columna 8 y linea 1
  display.print(" EA7HVO CONTROL ");
  display.setCursor(3, 19);      // ubica cursor en columna 8 y linea 1
  display.display();
  delay(1000);
  display.print("3 LOOPS OLED 128X32"); 
  display.display();
  delay(2000);
  display.clearDisplay();
  display.display();
  pantalla();
  //display.setCursor(12, 19);      // ubica cursor en columna 8 y linea 1
  //display.print("MEM    ");    
 ...
 if(digitalRead(UP)==LOW) //Si pulsamos el boton de UP
                            { if(ajuste == 1){          //si estamos en modo ajuste no cuenta pasos ( no suma a encodervalue)
                              ...
                              Time3 = millis();                           
                              digitalWrite(pololu, LOW);        // nivel bajo 
                              if(digitalRead(upSwitch)==LOW) {display.setCursor(12, 19);
                                                              display.print("                ");
                                                              display.display();
                                                              ajuste=0;
                                                              limitesup ();
                                ...
                                display.setCursor(66, 19);      // ubica cursor en columna 6 y linea 1
                                display.print("    "); 
                                display.display();                             
                                backlash++;
                                ...
                                display.setCursor(72, 19);      // ubica cursor en columna 6 y linea 1
                                display.print("  ");  
                                display.display(); 
                                enPolo++;
                                if (enPolo >1 ) enPolo = 0;
                                display.setCursor(78, 19);      // ubica cursor en columna 6 y linea 1
                                if(enPolo == 0) display.print("Y");  // si desabilitamos el pololu en reposo
                                if(enPolo == 1) display.print("N");  // si desabilitamos el pololu en reposo
                                display.display();
                                delay(200);
                                Time2 = millis();}
                                ...
                                mcr++;
                                if (mcr >= 5) mcr = 5;
                                display.setCursor(72, 19);      // ubica cursor en columna 10 y linea 1
 ...
 if(digitalRead(DOWN)==LOW) //si Pulsamos el boton de down
                            { if(ajuste == 1){      //si estamos en modo ajuste no cuenta pasos ( no suma a encodervalue)                              
                              ...
                              Time3 = millis();                          
                              digitalWrite(pololu, LOW);        // nivel bajo
                              if(digitalRead(lowSwitch)==LOW) {display.setCursor(12, 19);
                                                               display.print("                ");
                                                               display.display();
                                                               ajuste=0;
                                                               limiteinf ();
 ...
 {
 display.setCursor(12, 0);      // ubica cursor en columna 0 y linea 0
 if(encoderValue<10000 && encoderValue>=1000) display.print("0");
 if(encoderValue<1000 && encoderValue>=100) display.print("00");
 if(encoderValue<100 && encoderValue>=10) display.print("000");
 if(encoderValue<10) display.print("0000");
 display.print(encoderValue);   // escribe el valor de encodervalue
 display.display();
 ...
 lastencoderValue=encoderValue; //se iguala el valor obtenido como el ultimo leido
  ...
  if(digitalRead(UP)==LOW && digitalRead(DOWN)==LOW)   //reset encoderValue si pulsamos pin 17 y 11
              {
                  display.setCursor(12, 0);      // ubica cursor en columna 0 y linea 0
                  display.print("DELETTING MEMORY"); 
                  display.setCursor(12, 19);      // ubica cursor en columna 0 y linea 1  
                  display.print("      BANK      "); 
                  display.setCursor(78, 19);      // ubica cursor en columna 0 y linea 1 
                  display.print(antena);   
                  display.display();
                  delay(3000); 
                  upperlimit=64000;                                  
 ...
 if(digitalRead(menuPin)==LOW )   //Cambiamos el modo a MHZ de ajuste a amateur y a broadcast
              { 
                ...
                switch(funcionmenu){
                  ...
                  ajuste = 0;
                  display.setCursor(12, 19);      // ubica cursor en columna 0 y linea 1
                  display.print("MEM    ");   // escribe el valor de encodervalue
                  display.print("          ");  
                  display.display();
                  EEPROM.put(mempointer+38,microst);                                                                 
                  break;                  
                  ...
                  ajuste = 0;
                  display.setCursor(12, 19);      // ubica cursor en columna 0 y linea 1
                  display.print("ANT            ");   // escribe el valor de encodervalue
                  display.display();
                  ...
                  ajuste = 0;
                  display.setCursor(12, 19);      // ubica cursor en columna 0 y linea 1
                  display.print("SAVE         U/D");   // escribe el valor de encodervalue
                  display.display();
                  Time3 = millis();                                   
                  break;
                  ...
                  ajuste=1;
                  display.setCursor(12, 19);      // ubica cursor en columna 0 y linea 1
                  display.print("ADJUST");   // escribe el valor de encodervalue
                  display.print("       U/D");
                  display.display();
                  ...
                  EEPROM.get(mempointer+34,backlash); 
                  display.setCursor(12, 19);      // ubica cursor en columna 0 y linea 1
                  display.print("BACKLASH");   // escribe el valor de encodervalue
                  display.print("     U/D"); 
                  display.setCursor(66, 19);      // ubica cursor en columna 6 y linea 1
                  display.print(backlash);
                  display.display();
                  ...
                  ajuste=0;
                  display.setCursor(12, 19);      // ubica cursor en columna 0 y linea 1
                  display.print("SPEED   ");   // escribe el valor de encodervalue
                  display.print("     U/D"); 
                  display.setCursor(48, 19);      // ubica cursor en columna 6 y linea 1
                  display.print(sp);  
                  display.display();
